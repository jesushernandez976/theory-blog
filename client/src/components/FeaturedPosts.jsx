...
const FeaturedPosts = () => {
  ...
  return <p className="text-white">No featured posts found.</p>;
    ...
    <div className="mt-8 flex flex-col lg:flex-row gap-8">
      ...
      <div className="w-full lg:w-1/2 flex flex-col gap-4">
        ...
        <div className="flex items-center gap-4">
          <h1 className="font-semibold text-white lg:text-lg">01.</h1>
      ...
      <div className="w-full lg:w-1/2 flex flex-col gap-4">
        ...
        {posts[1] && <div className="lg:h-1/3 flex justify-between gap-4">
          ...
          <div className="w-2/3">
            ...
            <Link
              to={posts[1].slug}
              className="text-base sm:text-lg text-white md:text-2xl lg:text-xl xl:text-2xl font-medium"
            >
              {posts[1].title}
            </Link>
          </div>
        ...
        {posts[3] && <div className="lg:h-1/3 flex justify-between gap-4">
          ...
          <div className="w-2/3">
            {/* details */}
            <div className="flex items-center gap-4 text-sm lg:text-base mb-4">
              <h1 className="font-semibold text-white">04.</h1>
